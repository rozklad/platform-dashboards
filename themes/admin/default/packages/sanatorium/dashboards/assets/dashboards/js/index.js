...
;(function(window, document, $, undefined)
{
	...
	Extension.Index.datePicker = function()
	{
		...
		$('.daterangepicker_start_input').attr('data-grid', 'dashboard');

		$('.daterangepicker_end_input').attr('data-grid', 'dashboard');
	...
	Extension.Index.dataGrid = function()
	{
		...
		Extension.Index.Grid = $.datagrid('dashboard', '#data-grid', '#data-grid_pagination', '#data-grid_applied', config);
