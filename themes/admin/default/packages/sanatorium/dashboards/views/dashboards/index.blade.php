...
@section('title')
@parent
{{ trans('sanatorium/dashboards::dashboards/common.title') }}
@stop
...
{{ Asset::queue('index', 'sanatorium/dashboards::dashboards/js/index.js', 'platform') }}
...
<section class="panel panel-default panel-grid">
		...
		<nav class="navbar navbar-default navbar-actions">
			...
			<div class="container-fluid">
				...
				<div class="navbar-header">
					...
					<span class="navbar-brand">{{{ trans('sanatorium/dashboards::dashboards/common.title') }}}</span>
				...
				<div class="collapse navbar-collapse" id="actions">
					...
					<ul class="nav navbar-nav navbar-left">
						...
						<li class="primary">
							<a href="{{ route('admin.sanatorium.dashboards.dashboards.create') }}" data-toggle="tooltip" data-original-title="{{{ trans('action.create') }}}">
					...
					{{-- Grid: Filters --}}
					<form class="navbar-form navbar-right" method="post" accept-charset="utf-8" data-search data-grid="dashboard" role="form">
						...
						<div class="input-group">
							...
							<span class="input-group-btn">
								...
								<ul class="dropdown-menu" role="menu">
									...
									<li>
										<a data-grid="dashboard" data-filter="enabled:1" data-label="enabled::{{{ trans('common.all_enabled') }}}" data-reset>
											<i class="fa fa-eye"></i> {{{ trans('common.show_enabled') }}}
										</a>
									</li>

									<li>
										<a data-toggle="tooltip" data-placement="top" data-original-title="" data-grid="dashboard" data-filter="enabled:0" data-label="enabled::{{{ trans('common.all_disabled') }}}" data-reset>
							...
							<span class="input-group-btn">
								...
								<button class="btn btn-default" data-grid="dashboard" data-reset>
	...
	<div class="panel-body">
		...
		<div class="btn-toolbar" role="toolbar" aria-label="data-grid-applied-filters">
			...
			<div id="data-grid_applied" class="btn-group" data-grid="dashboard"></div>
	...
	<div class="table-responsive">
		...
		<table id="data-grid" class="table table-hover" data-source="{{ route('admin.sanatorium.dashboards.dashboards.grid') }}" data-grid="dashboard">
			<thead>
				<tr>
					<th><input data-grid-checkbox="all" type="checkbox"></th>
					<th class="sortable" data-sort="id">{{{ trans('sanatorium/dashboards::dashboards/model.general.id') }}}</th>
					<th class="sortable" data-sort="name">{{{ trans('sanatorium/dashboards::dashboards/model.general.name') }}}</th>
					<th class="sortable" data-sort="slug">{{{ trans('sanatorium/dashboards::dashboards/model.general.slug') }}}</th>
					<th class="sortable" data-sort="roles">{{{ trans('sanatorium/dashboards::dashboards/model.general.roles') }}}</th>
					<th class="sortable" data-sort="created_at">{{{ trans('sanatorium/dashboards::dashboards/model.general.created_at') }}}</th>
				</tr>
			</thead>
			<tbody></tbody>
		</table>
	...
	<footer class="panel-footer clearfix">
		...
		{{-- Grid: Pagination --}}
		<div id="data-grid_pagination" data-grid="dashboard"></div>

	</footer>

	{{-- Grid: templates --}}
	@include('sanatorium/dashboards::dashboards/grid/index/results')
	@include('sanatorium/dashboards::dashboards/grid/index/pagination')
	@include('sanatorium/dashboards::dashboards/grid/index/filters')
	@include('sanatorium/dashboards::dashboards/grid/index/no_results')

</section>

@if (config('platform.app.help'))
	@include('sanatorium/dashboards::dashboards/help')
@endif
