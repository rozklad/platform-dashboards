<script type="text/template" data-grid="dashboard" data-template="pagination">
		...
		<div class="pull-right">
			...
			<ul class="pagination pagination-sm">
				...
				<% if (p.previous_page !== null) { %>
					...
					<li><a href="#" data-grid="dashboard" data-page="1"><i class="fa fa-angle-double-left"></i></a></li>

					<li><a href="#" data-grid="dashboard" data-page="<%= p.previous_page %>"><i class="fa fa-chevron-left"></i></a></li>
				...
				<% for(i; i <= j; i++) { %>
					...
					<li><a href="#" data-grid="dashboard" data-page="<%= i %>"><%= i %></a></li>
				...
				<% if (p.next_page !== null) { %>
					...
					<li><a href="#" data-grid="dashboard" data-page="<%= p.next_page %>"><i class="fa fa-chevron-right"></i></a></li>

					<li><a href="#" data-grid="dashboard" data-page="<%= p.pages %>"><i class="fa fa-angle-double-right"></i></a></li>
